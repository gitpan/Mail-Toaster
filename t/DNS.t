...
$r = $dns->rbl_test(undef, "sbl.spamhaus.org", 0);
$r ? print "ok 3 - rbl_test\n" : print "not ok 3 - rbl_test\n";

$r = $dns->rbl_test_ns(undef, "sbl.spamhaus.org", "NS");
$r ? print "ok 4 - rbl_test_ns\n" : print "not ok 4 - rbl_test_ns\n";

$r = $dns->rbl_test_positive_ip(undef, "sbl.spamhaus.org");
$r ? print "ok 5 - rbl_test_positive_ip\n" : print "not ok 5 - rbl_test_positive_ip\n";

$r = $dns->rbl_test_negative_ip(undef, "sbl.spamhaus.org");
