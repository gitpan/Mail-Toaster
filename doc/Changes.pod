...
Moved Params::Validated into inc directory (prevent CPAN from presumign I provide it), moved Changes back into doc/Changes.pod, added include lib "inc" into all test files (forgot that with 5.02 release). 
